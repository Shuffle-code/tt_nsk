...
public class EnrollTournamentImpl_v2 implements EnrollTournament {
    ...
    public ResponseEntity<UpcomingTournamentData> announceTournament(@RequestBody AnnouncedTournament announcedTournament) {
        ...
        return new ResponseEntity<>(upcomingTournamentDataRepo.findLast(), HttpStatus.OK);
    }
    ...
    public List<PlayerTournament> getTournamentsByPlayerId(Long playerId) {
        //ToDo
        return (List) playerTournamentRepo.findAllByPlayerId(playerId);
    }
